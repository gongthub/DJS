                        ...
                        if (model != null)
                        {
                            ...
                            foreach (Control control in controls)
                            {
                                if (control.Name == "STATUS")
                                {
                                  ...
                                  XmlHelp.xmlHelp.SetValue(SDKCONFIGPath, cponfignames, "Name", control.Name, "Value", cbbox.SelectedValue.ToString());
                                }
                                else
                ...
                foreach (XmlNode node in nodes)
                {
                    if (node.Attributes["Name"] != null)
                    {
                        ...
                        else
                        {
                            ...
                            cbbox.SetBounds(120, 6, panlShow.Width - 120, 30);

                            cbbox.Name = names;

                            pan.Controls.Add(lbl);
                            pan.Controls.Add(cbbox);
                            pan.SetBounds(xnum, ynum, panlShow.Width, 30);

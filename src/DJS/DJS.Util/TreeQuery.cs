...
namespace DJS.Util
{
    ...
    {
        public static List<T> TreeWhere<T>(this List<T> entityList, Predicate<T> condition, string keyValue = "", string parentId = "") where T : class
        {
            keyValue = ConfigHelp.SYSKEYNAME;
            parentId = ConfigHelp.SYSPARENTKEYNAME;

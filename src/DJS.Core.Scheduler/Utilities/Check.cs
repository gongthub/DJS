...
namespace DJS.Core.Scheduler.Utilities
{
    public sealed class Check
    {
        ...
        public static string NotEmpty(string value, string parameterName)
        {
            ...
            {
                throw new ArgumentException(string.Format(SchedulerResources.ArgumentIsNullOrWhitespace, parameterName));
            }
        ...
        public static void CheckCondition(Func<bool> condition, string formatErrorText, params string[] parameters)
        {
            if (condition.Invoke())
            {
                throw new ArgumentException(string.Format(SchedulerResources.ArgumentIsNullOrWhitespace, parameters));
            }
        }
    }
}

...
namespace PMPSmallNodesExtensionSummary
{
    public class Achieve : IJob, IConfigClient
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            Service.SmallNodesExtensionSummary.SendSmallNodesExtensionSummaryEmail();
        ...
        public void SetConfig(string jobName)
        {
            ...
            if (!string.IsNullOrEmpty(configName))
            {
                ...
                iConfigMgr.SetConfig("EmailTitle", "PMP未完成小节点延期提醒"); //邮件的标题

                iConfigMgr.SetConfig("IDBRepository", "Data Source=.;User Id=sa;Password=123;Database=PMP;");

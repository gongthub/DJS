...
namespace RentLoanSummaryService
{
    public class Achieve : IJob, IConfigClient
    {
        ...
        public void SetConfig(string jobName)
        {
            ...
            if (!string.IsNullOrEmpty(configName))
            {
                ...
                iConfigMgr.SetConfig("ServiceCode", "S010");
                ...
                //【原】
                //iConfigMgr.SetConfig("IDBRepositoryEmailService", "Data Source=192.168.25.30;User Id=amssit;Password=amssitVlinker123;Database=AMS_SIT;");
                //【现、本地】
                iConfigMgr.SetConfig("IDBRepositoryEmailService", "Data Source=.;User Id=sa;Password=1234567890;Database=AMS;");
                //iConfigMgr.SetConfig("IDBRepositoryEmailService", "Data Source=192.168.25.20;User Id=SmallAmsSit;Password=1234567890;Database=SmallAms;");
                ...
                iConfigMgr.SetConfig("SystemName", "大V门店租金贷预警汇总");
            }
            else
            {

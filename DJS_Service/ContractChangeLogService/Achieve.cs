...
namespace ContractChangeLogService
{
    public class Achieve : IJob, IConfigClient
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                ContractChangeLogService.Service.ContractChangeLogService server = new Service.ContractChangeLogService();
        ...
        public void SetConfig(string jobName)
        {
            ...
            if (!string.IsNullOrEmpty(configName))
            {
                ...
                iConfigMgr.SetConfig("EmailTitle", "大V合同变更日志"); //邮件的标题

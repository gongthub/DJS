...
namespace DayTrialAfterCashService
{
    public class Achieve : IJob, IConfigClient
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                DayTrialAfterCashService.Service.DayTrialAfterCashService server = new Service.DayTrialAfterCashService();
                server.SendDayTrialAfterCash();

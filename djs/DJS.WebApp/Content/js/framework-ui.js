...
$.modalMsgSuccess = function (content) {
    var icon = "fa-check-circle";
    top.layer.msg(content, { icon: icon, time: 4000, shift: 5 });
    top.$(".layui-layer-msg").find('i.' + icon).parents('.layui-layer-msg').addClass('layui-layer-msg-success');
}
$.modalMsgError = function (content) {
    var icon = "fa-times-circle";
    top.layer.msg(content, { icon: icon, time: 4000, shift: 5 });
    top.$(".layui-layer-msg").find('i.' + icon).parents('.layui-layer-msg').addClass('layui-layer-msg-error');
}
$.modalMsgWarning = function (content) {
    var icon = "fa-exclamation-circle";
    top.layer.msg(content, { icon: icon, time: 4000, shift: 5 });
    top.$(".layui-layer-msg").find('i.' + icon).parents('.layui-layer-msg').addClass('layui-layer-msg-warning');
}
$.modalClose = function () {

...
namespace EmailToDayReportSumExcel.Utils
{
    public class EmailUtility
    {
        ...
        /// <returns></returns>
        public static AMSService GetService(string code)
        {
        ...
        /// <returns></returns>
        public static List<AMSServiceSet> GetServiceSet(string code)
        {

            List<AMSServiceSet> models = new List<AMSServiceSet>();
        ...
        /// <returns></returns>
        public static List<AMSServiceSet> GetServiceSet(string code, int type)
        {
            List<AMSServiceSet> models = new List<AMSServiceSet>();
            AMSService model = new AMSService();
            model = GetService(code);
        ...
        /// <param name="type">发送类型</param>
        /// <returns></returns>
        public static List<AMSServiceSetEmail> GetServiceSetEmail(string code)
        {
            List<AMSServiceSetEmail> models = new List<AMSServiceSetEmail>();
            List<AMSServiceSet> modelsets = new List<AMSServiceSet>();
            AMSService model = new AMSService();
            model = GetService(code);
            if (model != null)
            {
                ...
                if (modelsets != null && modelsets.Count > 0)
                {
                    ...
                    List<AMSServiceSetEmail> modelsT = new List<AMSServiceSetEmail>();
        ...
        public static List<string> GetServiceSetEmailTo(string code)
        {
            ...
            List<AMSServiceSetEmail> models = GetServiceSetEmail(code);
        ...
        /// <param name="type">发送类型</param>
        /// <returns></returns>
        public static List<AMSServiceSetEmail> GetServiceSetEmailStoresList(string code)
        {
            List<string> strs = new List<string>();
            List<AMSServiceSetEmail> models = GetServiceSetEmail(code);
